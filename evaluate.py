...
def evaluate(dataset, model):
    ...
    # net = Model(inputs=net.input, outputs=net.layers[9].output)
    # flatten_1
    print("Starting loadinging the CMC")
    ...
    print("Starting calculating the CMC")
