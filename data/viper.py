...
class VIPER(Dataset):
    """
        mode:
            source: 316 (train) + 316 (test) different identities.
            train:  316 different identities.
            test:   316 different identities.
    """
    
    def __init__(self, 
                 mode='source',
                 dataset_path=config.VIPER_DATA_DIR,
                 csv_path=config.VIPER_CSV_DIR,
